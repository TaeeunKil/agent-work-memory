...
from workalmanac.services.remotes import (
    RemoteAccessError,
...
from workalmanac.services.remotes.models import RemoteFileObservation
...
def test_doctor_explains_that_captured_sessions_need_distillation(
    ...
    assert "wa distill" in checks["knowledge"].message

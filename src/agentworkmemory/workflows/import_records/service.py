...
from agentworkmemory.integrations.record_bundle import load_record_bundle
from agentworkmemory.services.sessions.models import AgentEvent, CollectorCursor
from agentworkmemory.services.sessions.service import (
    SessionsService,
    stable_event_id,
)
...
class ImportAgentRecordResult(AgentWorkMemoryModel):
    session_id: str
    events_added: int
    wiki_path: Path

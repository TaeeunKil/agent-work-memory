...
class RemoteHost(WorkAlmanacModel):
    target: str
...
class RemoteFileObservation(WorkAlmanacModel):
    path: str
...
class RemoteManifest(WorkAlmanacModel):
    files: tuple[RemoteFileObservation, ...] = ()


class RemoteSnapshot(WorkAlmanacModel):
    local_home: Path
...
class RemoteSyncStatus(WorkAlmanacModel):
    target: str
...
class RemoteOverview(WorkAlmanacModel):
    host: RemoteHost
    status: RemoteSyncStatus


class RemoteRegistry(WorkAlmanacModel):
    hosts: tuple[RemoteHost, ...] = ()


class RemoteStatusLedger(WorkAlmanacModel):
